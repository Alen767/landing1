/*
Cache: jquery-lazy, thickbox, dt-main, dt-language, dt-main-op-jquery, dt-plugins, waypoints, vc_carousel_js, vc_transition_bootstrap_js, qfe_composer_front_js, wc-cart-fragments, jquery-cookie, bitcommerce, jquery-blockui, wc-cart, wc-country-select, jquery-form
*/
...
/* wc-country-select: (https://59f041758befa.t74.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/frontend/country-select.min.js) */
jQuery(function(a) { if ("undefined" == typeof wc_country_select_params) return !1; var b = wc_country_select_params.countries.replace(/&quot;/g, '"'),
        c = a.parseJSON(b);
    a("select.country_to_state, input.country_to_state").change(function() { var b = a(this).val(),
            d = a(this).closest("div").find("#billing_state, #shipping_state, #calc_shipping_state"),
            e = d.parent(),
            f = d.attr("name"),
            g = d.attr("id"),
            h = d.val(),
            i = d.attr("placeholder"); if (c[b])
            if (0 == c[b].length) d.parent().hide().find(".chosen-container").remove(), d.replaceWith('<input type="hidden" class="hidden" name="' + f + '" id="' + g + '" value="" placeholder="' + i + '" />'), a("body").trigger("country_to_state_changed", [b, a(this).closest("div")]);
            else { var j = "",
                    k = c[b]; for (var l in k) j = j + '<option value="' + l + '">' + k[l] + "</option>";
        ...
        a("body").trigger("country_to_state_changing", [b, a(this).closest("div")]) }).change() });;

/* wc-cart: (https://59f041758befa.t74.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/frontend/cart.min.js) */
jQuery(function(a) { return "undefined" == typeof wc_cart_params ? !1 : (a(document).on("click", ".shipping-calculator-button", function() { return a(".shipping-calculator-form").slideToggle("slow"), !1 }).on("change", "select.shipping_method, input[name^=shipping_method]", function() { var b = [];
        a("form:visible select.shipping_method,form:visible  input[name^=shipping_method][type=radio]:checked,form:visible  input[name^=shipping_method][type=hidden]").each(function() { b[a(this).data("index")] = a(this).val() }), a("div.cart_totals").block({ message: null, overlayCSS: { background: "#fff url(" + wc_cart_params.ajax_loader_url + ") no-repeat center", backgroundSize: "16px 16px", opacity: .6 } }); var c = { action: "bitcommerce_update_shipping_method", security: wc_cart_params.update_shipping_method_nonce, shipping_method: b };
        a.post(wc_cart_params.ajax_url, c, function(b) { a("div.cart_totals").replaceWith(b), a("body").trigger("updated_shipping_method") }) }), void a(".shipping-calculator-form").hide()) });;
        ...
        $('.add_to_cart_button-ajax').unbind().bind('click', function() {
            ...
            if ($thisbutton.is('.product_type_simple')) {
                ...
                $.post("/admin/admin-ajax.php", data, function(response) {
                    ...
                    qfy_popinfo_fun('<div style="text-align:center;" ><img class="qfy_pop_checkedimg"  style="margin-top:20px;margin-bottom:20px;" /><div style="padding-bottom:20px;">' + i18n_ajax_title + '</div></div>', i18n_ajax_closetime > 1 ? i18n_ajax_closetime : 1)
        ...
        $('.productlists.add_to_cart_button').unbind().bind('click', function() {
            ...
            if ($thisbutton.is('.product_type_simple')) {
                ...
                $.post("/admin/admin-ajax.php", data, function(response) {
                    ...
                    qfy_popinfo_fun('<div style="text-align:center;" ><img class="qfy_pop_checkedimg"  style="margin-top:20px;margin-bottom:20px;" /><div style="padding-bottom:20px;">' + wc_add_to_cart_params.i18n_ajax_title + '</div></div>', wc_add_to_cart_params.i18n_ajax_closetime > 1 ? wc_add_to_cart_params.i18n_ajax_closetime : 1)
        ...
        jQuery(obj).closest("form").ajaxSubmit({
            ...
            success: function(obj) {
                ...
                if (obj.status == "success") {
                    ...
                    var htm = obj.msg;
                    if (isajax == 2) {
                        qfy_popinfo_fun('<div style="text-align:center;" ><img class="qfy_pop_checkedimg"  style="margin-top:20px;margin-bottom:20px;" /><div style="padding-bottom:20px;line-height:30px;">' + text3 + '</div></div>', 3);
            ...
            jQuery('.content-wrapper .qfy-listcatecontrols li').each(function() {
                ...
                $li.mouseenter(function() {
                    ...
                    if (jQuery(this).find(".toEditor").length == 0) {
                        jQuery(this).append("<span class='toEditor' style='border:0;padding:0;'><span  style='display:inline;border:0;padding:0;background:transparent;' onclick='toDeleteCate(this)'></span>");
                    }
                }).mouseleave(function() {
...
function checkAdvertising() {
    ...
    if (bgcolor != "#000000" && bgcolor != "rgb(0, 0, 0)") { jAdObj.attr("style", style) }
